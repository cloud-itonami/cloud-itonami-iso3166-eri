(ns marketentry.marketentryllm
  ...
  the Eritrea (ERI) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "mining-sector?=" (:mining-sector? e)
                        " suppliers-solicited=" (:suppliers-solicited e)
                        " sole-supplier-market?=" (:sole-supplier-market? e)
                        " inland-revenue-record-verified?=" (:inland-revenue-record-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-inland-revenue-record? e))
                              (:inland-revenue-record-verified? e)))
                   0.9 0.3)}))
